...
// ヘイロー SVG（アバター用）
const HALO_SVG = `<svg width="18" height="18" viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg" fill="none">
  <defs>
    <mask id="halo-mask-dyn">
      <rect width="64" height="64" fill="white"/>
      <polygon fill="black" points="32,21 34,30 43,32 34,34 32,43 30,34 21,32 30,30"/>
    </mask>
  </defs>
  <polygon fill="#76c0ea" mask="url(#halo-mask-dyn)"
    points="32,4 37,27 60,32 37,37 32,60 27,37 4,32 27,27"/>
  <polygon fill="#76c0ea" opacity="0.5"
    points="32,17 34.5,29.5 47,32 34.5,34.5 32,47 29.5,34.5 17,32 29.5,29.5"/>
</svg>`;
...
function makeHaloSVG() {
  const uid = ++haloCount;
  return `<svg width="18" height="18" viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg" fill="none">
    <defs>
      <mask id="hm${uid}">
        <rect width="64" height="64" fill="white"/>
        <polygon fill="black" points="32,21 34,30 43,32 34,34 32,43 30,34 21,32 30,30"/>
    ...
    <polygon fill="#76c0ea" mask="url(#hm${uid})"
      points="32,4 37,27 60,32 37,37 32,60 27,37 4,32 27,27"/>
    <polygon fill="#76c0ea" opacity="0.5"
      points="32,17 34.5,29.5 47,32 34.5,34.5 32,47 29.5,34.5 17,32 29.5,29.5"/>
  </svg>`;
