...
const APP_VERSION    = '2025-05-23-r5';  // ← デプロイ時に変更
const WORKER_VERSION = '20250523d';
...
async function loadModel(key) {
  ...
  try {
    ...
    const isLockError  = err.message && err.message.includes('Access Handle');
    const isQuotaError = err.message && err.message.includes('QuotaExceeded');
